             ...
             <div role="navigation" class="flag-menu" id="flag-menu">
                <div class="flag-inner">           
                  <table cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <a href="#"><img src="../images/rmi_flag.png" alt="RMI Flag" hspace="10" style="width:60px;height:30px;" display="inline-block"></a><br />
                        <a href="#"><span lang="mh" xml:lang="mh">Kajin M̧ajeļ</span></a> 
<!--                        <a href="#">Kajin M̧ajeļ</a> -->
<!--                        <a href="#">Kajin Majel</a> -->
                      </td>
                      <td>
                        <a href="javascript:translate_to_english()"><img src="../images/us_flag.png" alt="USA Flag" hspace="10" style="width:60px;height:30px;" display="inline-block"></a><br />
                        <a href="javascript:translate_to_english()">English</a>
                      </td>
                    </tr>
                  </table>     
