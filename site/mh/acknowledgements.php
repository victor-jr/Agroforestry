...
<head>
    ...
    <title>Acknowledgements - Marshall Islands Agroforestry</title>
...
<p>Two “dashboards”, or websites, were developed during the course of this project. These sites regularly update and provide information about climate conditions in the Marshall Islands.</p>

<p>The <a target="_blank" href="http://apdrc.soest.hawaii.edu/dashboard_RMI/" style="color:lightblue;">“Marshall Islands Climate Outlook” (blue dashboard)</a> provides information about water and sky conditions. Recent and forecast conditions are updated monthly for temperature, rainfall, storms, sea level and waves, ocean conditions, and ENSO (El Niño, La Niña) indices. It is an ongoing collaboration between the Asia-Pacific Data Research Center (APDRC) and the NOAA NESDIS National Centers for Environmental Information (NCEI).</p>

<p>The <a href="index.php" style="color:lightgreen">“Agroforestry in the Climate of the Marshall Islands” website (green dashboard)</a> simplifies information from the climate outlook dashboard for the agroforestry sector. It provides agroforestry extension agents and community leaders with information about seasonal and long-term changes in climate, and general suggestions for adapting agroforestry to climate.</p>
...
<p>Additional “dashboards” for the emergency response sector or health sector could be created to pull information from the climate outlook site, and provide recommendations for those sectors. Please contact <a href="mailto:jimp@hawaii.edu">Dr. James Potemra</a> for technical advice.</p>

<h1 id="acknowledgements">Acknowledgements</h1>

<p>The project that produced this website was supported by the Department of Interior Pacific Islands Climate Science Center under Grant Number G14AP00184 from the United States Geological Survey, entitled “&#8201;‘Vegetative Guide &amp; Dashboard’ relating atoll traditional agroforestry recommendations to predicted climate and sea level conditions in the Marshall Islands.”  Its contents are solely the responsibility of the authors and do not necessarily represent the official views of the USGS.</p>

<h3>Project contacts</h3>

<p>Principal Investigator Maria Haws, Ph.D., Director, Pacific Aquaculture and Coastal Resources Center, College of Agriculture, Forestry and Natural Resource Management, University of Hawaiʻi at Hilo (<a href="mailto:haws@hawaii.edu">haws@hawaii.edu</a>). <a href="https://hilo.hawaii.edu/eeoaa/" target="_blank">UHH is an Equal Opportunity instituion.</a></p>

<p>"Green" webpage content lead Kathleen Friday, Program Manager for Forest Stewardship Program, <a href="https://www.fs.usda.gov/main/r5/communityforests" target="_blank">Pacific Southwest Region State & Private Forestry</a>, USDA Forest Service, Hilo HI (<a href="mailto:kfriday@fs.fed.us">kfriday@fs.fed.us</a>).</p>

<h3>Additional partners listed in grant proposal</h3>
...
<ul>
    ...
    <li>Dr. James Potemra, Manager, Asia-Pacific Data Research Center, International Pacific Research Center, School of Ocean and Earth Science and Technology, University of Hawaiʻi Mānoa.</li>
</ul>

<h3>Project staff and contractors</h3>
<ul>
    <li>Dr. Harley Manner, Emeritus Professor of Geography and Micronesian Studies, University of Guam.</li>
    <li>Rufus Lajkit, now State Forester, Ministry of Resources & Development</li>
    <li>Michael Best, Software Developer, University of Hawaiʻi at Hilo.</li>
    <li>Kennedy Kaneko, student, College of the Marshall Islands</li>
    <li>Victor Garcia Jr., student, University of Hawaii at Manoa</li>
</ul>
...
<ul>
  ...
  <li>Dr. Mary Spencer, Dean Emerita, College of Liberal Arts and Social Sciences, University of Guam</li>
  <li>Land Grant Program, College of the Marshall Islands</li>
  <li>Women United in the Marshall Islands (WUTMI)</li>
</ul>

<h2>Specific figures, tables and other content</h2>
<ul>
    <li>Figure by Nancy <strong>Hulbirt</strong> (University of Hawaii at Manoa), adapted from illustration by Duane Leewai, published in <a href="http://www.reefresilience.org/wp-content/uploads/Gombos-et-al.-2014-Coastal-Change-in-the-Pacific-Islands.pdf">Coastal Change in the Pacific Islands</a>, with permission from Meghan Gombos and John Marra.</li>
    <li>Karness <strong>Kusto</strong> and Jabukja Aikne. Republic of the Marshall Islands Ministry of Resources & Development. Table adapted from calendar provided to Kathleen Friday, April 2016, with permission from Karness Kusto.</li>
    <li><strong>Lander</strong>: Figure adapted from Figure 2 by Mark Lander, published in National Oceanic and Atmospheric Administration (NOAA) <a href="http://www.weather.gov/media/peac/PEU/PEU_v22_n1.pdf">Pacific ENSO Update, 1st Quarter, 2016. Vol. 22, No. 1</a>, with permission from Mark Lander.</li>
    <li>Lajkit <strong>Rufus</strong>: Figure created using data from Sutton.</li>
    <li>Sleeper <strong>Sared</strong>: Chuuk Department of Agriculture, Federated States of Micronesia. Personal communication with Kathleen Friday, March 2009. Any errors are the responsibility of K. Friday.</li>
    <li><strong>Sutton</strong>, J., Luchetti, N., Wright, E., Kruk, M.C., and Marra, J.J. 2015. An El Niño Southern Oscillation (ENSO) Based Precipitation Climatology for the United States Affiliated Pacific Islands (USAPI) using the PERSIANN Climate Data Record (CDR). NASA DEVELOP National Program, NOAA’s National Centers for Environmental Information, 477pp. <a href="ftp://ftp.ncdc.noaa.gov/pub/data/coastal/ENSO_Rainfall_Atlas.pdf">51 MB (PDF)</a></li>
    <li>Brian <strong>Vander Velde</strong>: Personal communication with Kathleen Friday, April 2015. Any errors are the responsibility of K. Friday.</li>
</ul>
