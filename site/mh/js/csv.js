 ...
 * https://github.com/cparker15/CSV-js
 * Copyright (C) 2009-2013 Christopher Parker
 *
...
(function (window, undefined) {
    ...
    function assembleObjects(tokenizedLines) {
        ...
        for (i = 1; i < tokenizedLines.length; i++) {
            ...
            /* Modified by Michael Best: ignore lines with too many fields */
            if (tokenizedLine.length > 0 && tokenizedLine.length <= keys.length) {
                obj = {};
