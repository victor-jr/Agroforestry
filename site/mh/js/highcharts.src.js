 ...
 *
 * Includes changes by Michael Best to support legends for pie chart series
 */
...
// encapsulated variables
        ...
        colorizeItem: function (item, visible) {
            var legend = this,
                ...
                textColor = visible ? options.itemStyle.color : hiddenColor,
                    /* mbest: include item.options.legendColor to support pie series legends */
                symbolColor = visible ? (item.legendColor || item.color || item.options.legendColor || '#CCC') : hiddenColor,
    ...
    Series.prototype = {
         ...
         */
        translate: function () {
            if (!this.processedXData) { // mbest: hidden series
                this.processData();
            }
            this.generatePoints();
            var series = this,
