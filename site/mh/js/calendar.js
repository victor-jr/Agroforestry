...
window.calendar = function(element, bare) {
    return $(element).highcharts({
        ...
        series: donutSeries([{
            ...
            name: 'Breadfruit',
            tableLabel: 'Breadfruit (<a href="http://www.hawaii.edu/cpis/MI/plants/ma.html">mā</a>, <a href="http://www.agroforestry.net/images/pdfs/A.mariannensis-dugdug.pdf">mejwaan</a>)',
